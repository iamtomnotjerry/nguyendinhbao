  ...
  return (
    <div className='bg-white p-6 rounded-md shadow-md mb-8'>
          ...
          <ul className='list-disc list-inside text-lg text-gray-700'>
            <li>Goal 1: Achieve a height of 175 cm and a weight of 75 kg - Current 170cm and 56.5</li>
            <li>Goal 2: Achieve a score of 9 in the IELTS exam - Current 5.5</li>
            <li>Goal 3: Finish reading 52 books - Current 0</li>
